...
std::vector<int>podzielnosc(std::vector<int>tab, int dzielnik, int reszta=0)
{
	std::vector<int>wynik;
	for (int i = 0; i < tab.size(); i++)
	{
...
int main()
{
	...
	std::cout << "\n";
	wypisz(podzielnosc(tab4, 3, 0));
	std::cout << "\n";
	int a;
	cin >> a;
	wypisz(losowyWektor(a, 0, 50));
	std::cout << "\n";

	wypisz(podzielnosc(losowyWektor(a, 0, 50), 3, 0));
	cout << "\n";
